...
// Outputs: 31-03-2019
                ...
                $brgs=mysqli_query($conn,"SELECT * FROM tb_order where tgl_transaksi = '$new_date' AND verifikasi = 'SUDAH' AND status = 'DIKIRIM' AND jenjang_pesan = 'sw' AND jkl = 'Perempuan' group by tb_order.id_order DESC");
            }else
...
$new_date = date("d-m-Y", $timestamp);
                ...
                $brgs=mysqli_query($conn,"SELECT * FROM tb_order where tgl_transaksi = '$new_date' AND verifikasi = 'SUDAH' AND status = 'DIKIRIM' AND jenjang_pesan = 'sw' AND jkl = 'Perempuan' AND kelas_pesan = '$kelas_pesan' group by tb_order.id_order DESC");
...
$tanggal = date('d-m-Y');
                                            $brgs=mysqli_query($conn,"SELECT * FROM tb_order where tgl_transaksi = '$tanggal' AND verifikasi = 'SUDAH' AND status = 'DIKIRIM' AND jenjang_pesan = 'sw' AND jkl = 'Perempuan' group by  tb_order.id_order DESC");
                                        }
                                            $no=1;
