...
<div class="w3-container">
  <h4>Produk Harian Yang Terjual Pada : Tanggal <?php echo $awal; ?> - <?php echo $akhir?></h4>
  ...
  <table class="w3-table w3-striped">
    <tr>
     ...
     <?php
                    $data = mysqli_query($conn,"SELECT produk.namaproduk, SUM(pembelian) AS total FROM tb_detail_order join produk on tb_detail_order.idproduk=produk.idproduk JOIN tb_order ON tb_detail_order.id_order=tb_order.id_order WHERE produk.idkategori != '1020304050' AND tb_order.bulan = '$bulan' and tb_order.tgl_transaksi BETWEEN '$awal' AND '$akhir' AND tb_order.status = 'diterima' GROUP BY produk.namaproduk");
...
<div class="w3-container">
  <h4>Produk PO Yang terjual Pada : Tanggal <?php echo $awal; ?> - <?php echo $akhir?></h4>
