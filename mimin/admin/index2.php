<?php 
	...
	$itungorder = mysqli_query($conn,"select count(id_order) as jumlahorder from tb_order");
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li><a href="../"><span>Kembali ke Toko</span></a></li>
                             ...
                             <li >
                                <a href="kelola_saldo.php"><i class="ti-dashboard"></i><span>Kelola Saldo</span></a>
                            </li>
                             <li>
                                <a href="kelola_transfer.php"><i class="ti-dashboard"></i><span>Kelola Pesanan Transfer</span></a>
                            </li>
                             <li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    Anda masuk sebagai <strong><?php echo $_SESSION['nama_admin'] ?></strong>
									<br>
								<p>Anda bertugas untuk memverifikasi saldo masuk, memverifikasi pesanan dengan metode transfer, dan memverifikasi pesanan dengan metode COD</p>
                                </div>
                            </div>
                        </div>
                    </div>
