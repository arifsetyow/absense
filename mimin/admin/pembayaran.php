										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													...
													<td> <form action="edit_pembayaran.php" method="POST" enctype="multipart/form-data">
    <input type="hidden" name="id_order" value="<?php echo $p['no'] ?>">
    <input type="submit" name="edit" value="Edit" class="w3-button w3-xlarge w3-green" />

        </form></td>
        <td> <form action="hapus_pembayaran.php" method="POST" enctype="multipart/form-data">
    <input type="hidden" name="id_order" value="<?php echo $p['no'] ?>">
    <input type="submit" name="kirim" value="Hapus" class="w3-button w3-xlarge w3-red" />
