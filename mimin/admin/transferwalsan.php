<?php 
    ...
    header("Content-Disposition: attachment; filename=RekapTransferWalsan.xls"); 
...
<body>
	...
	<center>
		<h1>Rekapan Semua Transfer Saldo WaliSantri</h1><br>
...
<th width="100%" >Tanggal</th>	
	...
	<th width="50%">Bukti Transfer</th>
		...
		// koneksi database
				...
				$data = mysqli_query($conn,"SELECT * FROM `saldo` join login on saldo.userid=login.userid WHERE verifikasi = 'sudah' ORDER BY id_saldo ASC;");
...
$data1 = mysqli_query($conn,"select sum(jumlah) as totalnya from saldo WHERE verifikasi = 'sudah'");
