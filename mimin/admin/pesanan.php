...
<form method="get">
            ...
            <input type="submit" value="FILTER">
                ...
                $brgs=mysqli_query($conn,"SELECT * from tb_order join login on tb_order.userid=login.userid where tgl_transaksi = '$tgl'");
            }else{

                                            $brgs=mysqli_query($conn,"SELECT * from tb_order join login on tb_order.userid=login.userid ");
                                        }
                                            $no=1;
