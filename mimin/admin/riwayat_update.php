								...
								<br>
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from produk join riwayat on produk.idproduk=riwayat.idproduk where riwayat.idproduk = '$id'");
											$no=1;
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													...
													<td><?php echo $p['jumlah'] + $p['jumlah_masuk'] ?></td>
