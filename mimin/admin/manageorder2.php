...
-->
    <br><br>
                ...
                $brgs=mysqli_query($conn,"SELECT * from tb_order join login on tb_order.userid=login.userid where tgl_transaksi = '$tgl' AND verifikasi = 'SUDAH' order by tb_order.id_order DESC");
            }else{

                                            $brgs=mysqli_query($conn,"SELECT * from tb_order join login on tb_order.userid=login.userid where verifikasi = 'SUDAH'order by tb_order.id_order DESC");
                                        }
                                            $no=1;
 ...
 <td><a href="order.php?id_order=<?php echo $p['id_order'] ?>">#<?php echo $p['id_order'] ?></a></td>
                                                    ...
                                                    <td><?php echo $p['santri'] ?></td>
                                                    <td><?php echo $p['kelas'] ?></td>
                                                    <td><?php echo $p['status'] ?></td>
                                                     <td><?php echo $p['tgl_transaksi'] ?></td>
                                                     <td> <form action="download.php" method="POST" enctype="multipart/form-data">
