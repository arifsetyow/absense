...
<?php 
	...
	{
		$namakategori = strtoupper($_POST['namakategori']);
	...
	if(isset($_POST["hapus"])) {
		$kode_brg=$_POST['kode_brg'];
			  ...
			  $query = "DELETE FROM kategori WHERE idkategori = '$kode_brg'";
                                ...
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout"></i><span>Kelola Toko
                                   ...
                                   <ul class="collapse">
                                    ...
                                    <li><a href="produk.php">Produk Harian</a></li>
                                     ...
                                     <li><a href="produkpo.php">Produk POo</a></li>
										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													...
													<td><form action="edit_kategori.php" method="post">
									<input type="hidden" name="id_kategori" value="<?php echo $p['idkategori']; ?>">
									
									<input type="submit" name="edit" value="EDIT" class="w3-card w3-button w3-orange w3-text-white">
								</fieldset>
							</form></td>
							<td><form action="#" method="post">
									<input type="hidden" name="kode_brg" value="<?php echo $p['idkategori']; ?>">
									
									<input type="submit" name="hapus" value="HAPUS" class="w3-card w3-button w3-red w3-text-white">
								</fieldset>
							</form></td>
												</tr>		
